                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <a href="#" class="btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">{{ __('Professional Team') }}</a>
                        </div>
                        <!--end::Name-->
                        ...
                        <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                            ...
                            <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                ...
                                @foreach(\App\Core\Data::getCountriesList() as $key => $value)
                                    {{ $key === old('country', $info->country ?? '') ? $value['name'] : '' }}
                                @endforeach
                            </a>
                    ...
                    <div class="d-flex flex-column flex-grow-1 pe-8">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">{{ __('Tasks') }}</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">{{ __('Objectives') }}</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">{{ __('Milestones') }}</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                        </div>
